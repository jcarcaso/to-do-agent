...
- create_task: { "title": "...", "priority": "medium", "dueDate": "YYYY-MM-DD", "type": "other", "description": "..." }. Only "title" is required.
- update_task: { "taskId": "<ID from PENDING TASKS>", "fields": { "title": "...", "priority": "...", "dueDate": "...", "description": "..." } }. Only include fields that should change.
